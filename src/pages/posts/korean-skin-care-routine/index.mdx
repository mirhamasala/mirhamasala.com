...
👉🏻 **Side note: **Double cleansing, that is, following [step 1](#step-one) and [step 2](#step-two), is considered to be the holy grail of the Korean skin care routine. And if you’re going to give the Korean way a go, then you should start with adding the double cleanse to your routine.
...
👉🏻 **Side note:** You can apply the Vitamin C Serum or BHA Liquid either directly after cleansing ([step 2](#step-two)) or after toning ([step 3](#step-three)). Ideally, you’ll then wait 15-30 minutes before moving on to the next steps. Most of the time, however, I don’t wait at all. Also, if you do decide to use these products in the morning, you must not forget to wear sunscreen.
...
👉🏻** Side note:** Whitening in Korean means brightening, and not, *bleaching. (Related reading: [“K-beauty Translations: What Does ‘Whitening’ on K-beauty Products Actually Mean?”](https://theklog.co/what-whitening-means-in-korean-beauty/))*
...
The 10-Step Korean Skin Care Routine is one of the favorites that made my: “[Favorite Things 2017](/posts/favorite-things-2017/)” list.
