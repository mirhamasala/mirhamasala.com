...
export const meta = {
  ...
  description:
    "Besides following my spin-off list, which allows me to experience 12 different lifestyles in one year, I also like to keep a classic bucket list. Writing down my goals and dreams helps me to achieve them one at a time. Last updated: October 5, 2017 Couple of years back, as part of an exercise in _The 4-Hour …",
  id: "2595",
  slug: "bucket-list",
  status: "publish",
  tags: [],
...
Couple of years back, as part of an exercise in [The 4-Hour Workweek](/read-100-books#36-the-4-hour-workweek), I wrote the following 5 goals and dreams down on a piece of paper:
...
10. ~~Improve reading speed~~_I tried [Timothy Ferriss’s speed reading method](http://tim.blog/2009/07/30/speed-reading-and-accelerated-learning/) and [Legentas’s online speed reading course](https://www.legentas.com/eng/), but unfortunately, neither seem to have produced lasting results._
11. ~~Do a Photoshop course~~_See: [30 Days of Photography: The Pictures, the Process, and the Skills behind the Progress](/tsop/posts/30-days-photography/)_
12. ~~Learn HTML + CSS~~
