...
🗺 I’m currently working on [Wagon City Guides](https://github.com/mirhamasala/lw_city_guide), a city guide app for Le Wagon’s campuses (the coding bootcamp where I learned to code).
...
The project is part of my [web dev MBA curriculum](/posts/leap-of-code#the-curriculum) about which you can read more in my post [Leap of Code](/posts/leap-of-code).
