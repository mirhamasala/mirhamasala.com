...
[Juggling](/dropbox#bucket-list-19-learn-to-juggle-limes) and [cartwheels](/dropbox#bucket-list-18-learn-to-do-a-cartwheel) are also part of my repertoire now.
...
📖 [Tools of Titans](/posts/read-100-books#42-tools-of-titans) by Timothy Ferriss\
...
🍳 I’m yet to try a recipe from [Diet Doctor](https://www.dietdoctor.com/low-carb/keto/recipes) that I don’t like. My current pick is the [Keto Salmon Tandoori with Cucumber Sauce](https://www.dietdoctor.com/recipes/keto-salmon-tandoori-cucumber-sauce), which I like to pair with [coconut flour flatbreads](/dropbox#coconut-flour-flatbreads-recipe).
