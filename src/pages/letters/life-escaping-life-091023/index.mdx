...
export const meta = {
  ...
  description:
    "Unable to be mindful in each moment of my parents' visit, I try to slow down and cherish our time together by punctuating the present with instants of deep attention.",
  emoji: "⏳",
