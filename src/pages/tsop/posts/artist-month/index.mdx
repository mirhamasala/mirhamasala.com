...
export const meta = {
  categories: ["artist", "spin-off"],
  date: "2012-09-14T07:59:27",
  date_modified: "2017-05-02T07:52:55",
  description:
    "Curious to know what my life as an artist would be like, I immersed myself, day in, and day out, for one month in making art. These are my stories and experiences from my month as an artist told through a series of questions.",
  id: "356",
  slug: "artist-month",
  published: true,
...
![Mirha Masala on the street picking up fallen love letters and putting them back into a trash bag.](/pages/tsop/posts/artist-month/memory-bytes_2b.jpg)
...
During my childhood, however, being an artist wasn’t something that was promoted by my parents or society. Only the lucky few could be an artist.
...
So, as I couldn’t even draw a cloud (and still can’t), I grew up thinking I wasn’t creative and pursued no artistic life whatsoever.
...
I needed to prove to myself that there was nothing that I can’t do.
...
That being said, I loved being an artist. It’s the one thing that I have done in a long time (forever, likely) that didn’t feel so serious. It made life less real and turned the world into a playground. It was fun.
...
I came up with a photography project, [Memory Bytes](/tsop/posts/memory-bytes). It’s about revenge, memories and the art of letting go.

## 4. What did you like best about being an artist?

I liked being in the process of making art. So, coming up with ideas, shaping them into reality and seeing the result. It felt like I was in a different reality when working on Memory Bytes.
...
Plus there are plenty of fantastic tools and applications that can help us to create and shape our artistic projects into high-quality work.
