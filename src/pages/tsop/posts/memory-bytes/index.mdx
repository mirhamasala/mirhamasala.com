...
export const meta = {
  ...
  description:
    "My first artistic project, Memory Bytes, is about revenge, memories and the art of letting go. Follow me through the dark of the night as I rid myself of my past and mature in the process.   Last edited: November 21, 2014 For years I kept love letters from ex-partners. I also kept notes from …",
  id: "383",
  slug: "memory-bytes",
  status: "publish",
  tags: [],
...
_My first artistic project, Memory Bytes, is about revenge, memories and the art of letting go. Follow me through the dark of the night as I rid myself of my past and mature in the process.  _
...
## The ideas behind _Memory Bytes_

### Idea #1: Revenge and the digitalization of memories

The initial idea that I had for _Memory Bytes_ was to photograph every piece of paper, letter or object and to then display these photos in a (online) gallery–making for a very private and dramatic showpiece.
...
This experience brought me to a more mature and graceful idea for _Memory Bytes._
...
I chose for a fancy skirt and high heels because I like the contrast it casts between dressing up and taking out the trash. It also adds a touch of drama to the atmosphere.

The outfit, furthermore, makes it look like the woman is on her way to a party. I wanted to emphasize the ease of which she lets go of her past and to hint to her present and future.

_In case you are wondering: the memorabilia was left in the trash container. And I, once done with the shoot, walked with my present and future to a dinner party._
...
To photographer [Arnej Misirlić](http://www.amphoto.ba/) for taking the pictures for _Memory Bytes_.
