...
export const meta = {
  ...
  description:
    "Before you start contacting web design and development companies about a customized website, it’s important that you first find out what you need. The following three steps will help you get your ideas across, so that you can get the customized website you want. Last edited: March 5, 2015 Step 1: Describe what your …",
  id: "2369",
...
_Before you start contacting web design and development companies about a customized website, it’s important that you first find out what you need. The following three steps will help you get your ideas across, so that you can get the customized website you want._
...
If the company hasn’t made anything you like, there’s no point in contacting them in the first place. _(Related reading: [How to Find the Right Web Design and Development Company](/tsop/posts/finding-web-design-development-company/)) _
...
The easiest way to find this out is by Googling: *features websites must have*; *element websites must have *or* what makes a great websites*. Read all the relevant articles that you can find.
...
_Side note: One important thing to note is that I never asked for a mobile version of the website. This should be the first feature you ask for. If you leave it out, your website will be pretty much useless across smartphones and tablets._
...
[Design Meltdown](http://www.designmeltdown.com/) displays a gallery of websites with beautiful web design.

You can filter the kind of websites you’re interested in by choosing, for example, the color or typography style, the site type (fashion, e-commerce, etc.) or design style (hipster, minimal, etc.).

It’s a great place to start discovering what goes into web design. Furthermore, you can use these examples for inspiration and to get a better understanding of what you want for your own customized website.
