...
export const meta = {
  ...
  related_reading: {
    emoji: "🎰",
    title: "Little Bets",
    url: "/posts/read-100-books#84-little-bets",
  },
...
> Lucky people tend to be open to opportunities (or insights) that come along spontaneously, whereas unlucky people tend to be creatures of routine, fixated on certain specific outcomes. –Richard Wiseman via Peter Sims, [Little Bets](/posts/read-100-books#84-little-bets)
