...
export const meta = {
  ...
  date: "2023-07-31",
  date_modified: "",
  description: "Drawing from good habits, I reach work-life balance, but the irony isn't lost on me.",
  emoji: "⚖️",
...
When I had to be let go, my instinct was to protect my mental state. Job searching can be such a taxing drag.
...
**Hi, All!** How are you? 🍉 I'm savoring the abundant summer days with expeditions to nearby sands and villages, sun-drenched after-work Vermouth potations at my favorite taberna, and elaborate barbecues with farm-sourced produce bringing back childhood tastes like those of stone fruit and simple dishes like heirloom tomatoes with olive oil, vinegar, and salt. And come Monday, I start my new job, thrilled about the work and optimistic about preserving that precious balance.
