...
export const meta = {
  ...
  description: "I'm bringing up the topic that is critical to good health, yet I least like discussing: nutrition. And I share the current state of my own diet.",
  slug: "heal-111222",
  status: "published",
  title: "Heal",
  tags: ["diet"],
